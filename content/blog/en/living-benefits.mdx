...
# image: "/synergy/blog-door-handle.jpg"   # replaced 2026-08 — client-supplied photo matched by name; old stock kept for restore
image: "/blog-gallery/living-benefits.jpg"
# imageAlt: "An ornate brass handle on a panelled door, daylight through the glass beside it."   # described the PRIOR stock; new card image is decorative (card title h2 is the links name)
---
